...
- **[d2l-ai/d2l-zh](https://github.com/d2l-ai/d2l-zh)** ⭐ 70,739 - 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被70多个国家的500多所大学用于教学。
...
- **[ymcui/Chinese-LLaMA-Alpaca](https://github.com/ymcui/Chinese-LLaMA-Alpaca)** ⭐ 18,879 - 中文LLaMA&Alpaca大语言模型+本地CPU/GPU训练部署 (Chinese LLaMA & Alpaca LLMs)
...
- **[zergtant/pytorch-handbook](https://github.com/zergtant/pytorch-handbook)** ⭐ 21,067 - pytorch handbook是一本开源的书籍，目标是帮助那些希望和使用PyTorch进行深度学习开发和研究的朋友快速入门，其中包含的Pytorch教程全部通过测试保证可以成功运行
...
- **[ShusenTang/Dive-into-DL-PyTorch](https://github.com/ShusenTang/Dive-into-DL-PyTorch)** ⭐ 18,960 - 本项目将《动手学深度学习》(Dive into Deep Learning)原书中的MXNet实现改为PyTorch实现。
...
- **[jikexueyuanwiki/tensorflow-zh](https://github.com/jikexueyuanwiki/tensorflow-zh)** ⭐ 12,378 - 谷歌全新开源人工智能系统TensorFlow官方文档中文版
...
- **[ymcui/Chinese-BERT-wwm](https://github.com/ymcui/Chinese-BERT-wwm)** ⭐ 10,020 - Pre-Training with Whole Word Masking for Chinese BERT（中文BERT-wwm系列模型）
...
- **[YaoFANGUK/video-subtitle-remover](https://github.com/YaoFANGUK/video-subtitle-remover)** ⭐ 7,226 - 基于AI的图片/视频硬字幕去除、文本水印去除，无损分辨率生成去字幕、去水印后的图片/视频文件。无需申请第三方API，本地实现。AI-based tool for removing hard-coded subtitles and te...
...
- **[ddean2009/MoneyPrinterPlus](https://github.com/ddean2009/MoneyPrinterPlus)** ⭐ 4,547 - AI一键批量生成各类短视频,自动批量混剪短视频,自动把视频发布到抖音,快手,小红书,视频号上,赚钱从来没有这么容易过! 支持本地语音模型chatTTS,fasterwhisper,GPTSoVITS,支持云语音：Azure,阿里云,腾...
...
- **[babysor/MockingBird](https://github.com/babysor/MockingBird)** ⭐ 36,452 - 🚀AI拟声: 5秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
- **[jingyaogong/minimind](https://github.com/jingyaogong/minimind)** ⭐ 23,109 - 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
...
- **[NLP-LOVE/ML-NLP](https://github.com/NLP-LOVE/ML-NLP)** ⭐ 16,948 - 此项目是机器学习(Machine Learning)、深度学习(Deep Learning)、NLP面试中常考到的知识点和代码实现，也是作为一个算法工程师必会的理论基础知识。
...
- **[GanymedeNil/document.ai](https://github.com/GanymedeNil/document.ai)** ⭐ 3,679 - 基于向量数据库与GPT3.5的通用本地知识库方案(A universal local knowledge base solution based on vector database and GPT3.5)
...
- **🏷️ Classification**: Based on [Toolify.ai](https://www.toolify.ai/) category system
...
2. Add your tool to the appropriate category based on [Toolify.ai](https://www.toolify.ai/) classification
3. Follow the format: `**[Tool Name](link)** ⭐ stars - Brief description`
4. Ensure the tool meets our inclusion criteria
...
- 🏷️ **Categorizes** tools using [Toolify.ai](https://www.toolify.ai/) classification system
...
_This list is maintained with ❤️ by the AI community. Classification system inspired by [Toolify.ai](https://www.toolify.ai/). Star ⭐ this repository to help others discover these amazing tools!_
